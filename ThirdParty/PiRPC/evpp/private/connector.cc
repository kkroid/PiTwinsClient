...
void Connector::Start() {
    ...
    timer_ = std::make_unique<TimerEventWatcher>(loop_, std::bind(&Connector::OnConnectTimeout, shared_from_this()), timeout_);
    timer_->Init();
    timer_->AsyncWait();
...
void Connector::Connect() {
    ...
    chan_ = std::make_unique<FdChannel>(loop_, fd_, false, true);
